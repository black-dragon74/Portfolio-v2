...
const Resume = () => {
    ...
    return (
        <Layout title={title}>
            <InnerViewHolder>
                <section id={styles.resume} className={styles.resume}>
                    <div className="container">
                        <div className="sectionTitle">
                            <h2>Resume</h2>
                            <p data-aos={"fade-in"}>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa debitis dignissimos dolore dolorem ea eligendi eos expedita, laborum laudantium odit officiis quis
                                ratione repellat sed vero voluptate voluptatibus. Minus, repellat!
                            </p>
                        </div>

                        <div className="row">
                            <div className="col-lg-6" data-aos={"fade-up"}>
                                <h3 className={styles.resumeTitle}>Summary</h3>
